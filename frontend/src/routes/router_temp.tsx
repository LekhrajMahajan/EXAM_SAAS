...
// unused SystemSettingsPage import removed
...
import { MASettingsLayout } from '@/features/master-admin/components/settings/MASettingsLayout';
...
replace /> },
              ...
              {
                path: 'settings',
                element: <MASettingsLayout><Outlet /></MASettingsLayout>,
                children: [
                  { index: true, element: <Navigate to="/master-admin/settings/general" replace /> },
                  { path: 'general', element: <MAGeneralSettingsPage /> },
                  { path: 'organization', element: <MAOrganizationSettingsPage /> },
                ]
              },
              { path: 'tickets/:id', element: <SupportTicketsPage /> },
            ],
          },
        ],
      },
