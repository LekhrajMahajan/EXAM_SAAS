...
import { GeneralSettingsPage as MAGeneralSettingsPage } from 
"../features/master-admin/pages/settings/GeneralSettingsPage";
...
import { OrganizationSettingsPage as MAOrganizationSettingsPage } from 
'@/features/master-admin/pages/settings/OrganizationSettingsPage';
import { SecuritySettingsPage as MASecuritySettingsPage } from 
'@/features/master-admin/pages/settings/SecuritySettingsPage';
import { NotificationSettingsPage as MANotificationSettingsPage } from 
'@/features/master-admin/pages/settings/NotificationSettingsPage';
import { EmailSmsGatewayPage } from '@/features/master-admin/pages/settings/EmailSmsGatewayPage';
import { StorageSettingsPage as MAStorageSettingsPage } from 
'@/features/master-admin/pages/settings/StorageSettingsPage';
...
import { SecurityReportsPage as MASecurityReportsPage } from 
'@/features/master-admin/pages/reports/SecurityReportsPage';
...
// Company Question Bank Pages - Modules
import { QuestionListPage } from '@/features/company/question-bank/pages/QuestionListPage';
import { CreateQuestionPage } from '@/features/company/question-bank/pages/CreateQuestionPage';
import { EditQuestionPage } from '@/features/company/question-bank/pages/EditQuestionPage';
import { QuestionDetailsPage } from '@/features/company/question-bank/pages/QuestionDetailsPage';
import { ImportQuestionsPage } from '@/features/company/question-bank/pages/ImportQuestionsPage';
import { ImportHistoryPage as ImportHistoryPage } from '@/features/company/question-bank/pages/ImportHistoryPage';
import { DownloadTemplatePage } from '@/features/company/question-bank/pages/DownloadTemplatePage';
import { ImportPreviewPage } from '@/features/company/question-bank/pages/ImportPreviewPage';
import { ImportErrorsPage } from '@/features/company/question-bank/pages/ImportErrorsPage';

// Company Paper Setter Pages
import { CreatePaperPage } from '../features/company/paper/pages/CreatePaperPage';
import { ShiftListPage } from '../features/company/shift/pages/ShiftListPage';
import { CreateShiftPage } from '../features/company/shift/pages/CreateShiftPage';
import { ShiftDetailsPage } from '../features/company/shift/pages/ShiftDetailsPage';
import { EditShiftPage } from '../features/company/shift/pages/EditShiftPage';
import { ShiftCalendarPage } from '../features/company/shift/pages/ShiftCalendarPage';
import { CapacityManagementPage } from '../features/company/shift/pages/CapacityManagementPage';
...
import { AdmitCardListPage } from '../features/company/admit-card/pages/AdmitCardListPage';
import { GenerateAdmitCardPage } from '../features/company/admit-card/pages/GenerateAdmitCardPage';
import { AdmitCardDetailsPage } from '../features/company/admit-card/pages/AdmitCardDetailsPage';
import { PrintPreviewPage } from '../features/company/admit-card/pages/PrintPreviewPage';
import { GenerationHistoryPage } from '../features/company/admit-card/pages/GenerationHistoryPage';
...
import { VerificationHistoryPage as EntryVerificationHistoryPage } from 
'../features/company/entry-verification/pages/VerificationHistoryPage';
...
import { VerificationDetailsPage as BiometricDetailsPage } from 
'../features/company/biometric/pages/VerificationDetailsPage';
import { VerificationHistoryPage as BiometricHistoryPage } from 
'../features/company/biometric/pages/VerificationHistoryPage';
...
const RoleBasedDashboardRedirect = () => {
  ...
  if (role === 'MASTER_ADMIN' || role === 'Master Admin') return <Navigate to="/master-admin/dashboard" replace />;
  if (role === 'COMPANY_ADMIN' || role === 'Company Admin') return <Navigate to="/company/dashboard" replace />;
  if (role === 'CANDIDATE' || role === 'Candidate') return <Navigate to="/candidate/dashboard" replace />;
  if (role === 'EXAM_MANAGER' || role === 'Exam Manager') return <Navigate to="/exam-manager/dashboard" replace />;

  // All other roles get the RoleDashboard (reads role from JWT)
  if (role === 'PAPER_SETTER' || role === 'QUESTION_SETTER' || role === 'Paper Setter') return <Navigate 
to="/dashboard/paper-setter" replace />;
  if (role === 'OBSERVER' || role === 'Observer') return <Navigate to="/dashboard/observer" replace />;
  if (role === 'TECHNICAL_MANAGER' || role === 'Technical Manager') return <Navigate to="/dashboard/technical-team" 
replace />;
  if (role === 'CENTER_MANAGER' || role === 'Center Manager') return <Navigate to="/dashboard/center-manager" replace 
/>;
  if (role === 'COMMAND_CENTER' || role === 'Command Center') return <Navigate to="/dashboard/command-center" replace 
/>;
  if (role === 'AI_PROCTOR' || role === 'AI Proctor') return <Navigate to="/dashboard/ai-proctor" replace />;
  if (role === 'BIOMETRIC_VERIFIER' || role === 'Biometric Verifier') return <Navigate 
to="/dashboard/biometric-verifier" replace />;
  if (role === 'ENTRY_CHECKER' || role === 'Entry Checker') return <Navigate to="/dashboard/entry-checker" replace />;
  if (role === 'INVIGILATOR' || role === 'Invigilator') return <Navigate to="/dashboard/invigilator" replace />;
  if (role === 'GOVT_AUTHORITY' || role === 'Govt Authority' || role === 'Government Authority') return <Navigate 
to="/dashboard/govt-authority" replace />;

  // Universal fallback â€” RoleDashboard handles anything else
...
export const router = createBrowserRouter([
  ...
  // Center Manager Mandatory Onboarding Setup Wizard
  {
    ...
    element: <ProtectedRoute><CenterOnboarding /></ProtectedRoute>,
  },
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { path: 'center-manager/assign-candidate-seat-allocation', element: <AssignCandidateSeatAllocationPage 
/> },
              { path: 'center-manager/assigned-candidate-attendance', element: <AssignedCandidateAttendancePage /> },
              ...
              { path: 'paper-setter/workspace/:paperId/subject/:subjectName', element: <PaperSetterSubjectWorkspace /> 
},
          ...
          // â”€â”€â”€ Developer Tools â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          {
            path: 'dev-tools',
            element: (
          ...
          // â”€â”€â”€ Candidate Routes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          {
            path: 'candidate',
            element: (
          ...
          // â”€â”€â”€ Company Admin Routes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          {
            path: 'company',
            element: (
            ...
            children: [
              ...
              { path: 'centers/pending-verifications', element: <CenterPendingVerificationsPage /> },
              ...
              { path: 'centers/:id/assigned-candidate-attendance', element: <AssignedCandidateAttendancePage /> },
              ...
              { path: 'question-bank/import/history', element: <ImportHistoryPage /> },
              { path: 'question-bank/import/template', element: <DownloadTemplatePage /> },
              { path: 'question-bank/import/preview', element: <ImportPreviewPage /> },
              { path: 'question-bank/import/errors', element: <ImportErrorsPage /> },
              { path: 'question-bank/:id', element: <QuestionDetailsPage /> },
              ...
              { path: 'shifts/:id/calendar', element: <ShiftCalendarPage /> },
              { path: 'shifts/:id/capacity', element: <CapacityManagementPage /> },
              ...
              { path: 'admit-cards', element: <AdmitCardListPage /> },
              { path: 'admit-cards/generate', element: <GenerateAdmitCardPage /> },
              { path: 'admit-cards/:id', element: <AdmitCardDetailsPage /> },
              { path: 'admit-cards/:id/preview', element: <PrintPreviewPage /> },
              { path: 'admit-cards/history', element: <GenerationHistoryPage /> },
              ...
              { path: 'reports', element: <Navigate to="/company/reports/dashboard" replace /> },
          ...
          // â”€â”€â”€ Exam Manager Routes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          {
            path: 'exam-manager',
            element: (
          ...
          // â”€â”€â”€ Master Admin Routes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          {
            path: 'master-admin',
            element: (
              <RoleGuard allowedRoles={['Master Admin']}>
            ...
            children: [
              ...
              { path: 'access-management/users', element: <Navigate to="/master-admin/access-management?tab=users" 
replace /> },
              { path: 'access-management/roles', element: <Navigate to="/master-admin/access-management?tab=roles" 
replace /> },
              ...
              { path: 'access-management/roles/:id/permissions', element: <AssignPermissionsPage /> },
              ...
              { path: 'reports', element: <Navigate to="/master-admin/reports/dashboard" replace /> },
              ...
              { path: 'settings', element: <Navigate to="/master-admin/system-settings" replace /> },
  ...
  // â”€â”€â”€ Exam Arena Routes (Independent from main layout) â”€â”€â”€
  {
