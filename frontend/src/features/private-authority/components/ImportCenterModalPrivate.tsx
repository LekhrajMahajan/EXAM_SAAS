...
export function ImportCenterModalPrivate({ onSuccess }: { onSuccess?: (importId: string, examName: string, count: number) => void } = {}) {
      ...
      <DialogContent className='sm:max-w-md bg-card border-border text-card-foreground'>
        ...
        <div className='grid gap-4 py-4 overflow-hidden'>
          <div className='space-y-2 min-w-0'>
            <Label htmlFor='exam-select-center-private'>Select Exam</Label>
            <Select onValueChange={(val) => setSelectedExamId(val)} value={selectedExamId}>
              <SelectTrigger id='exam-select-center-private' className='w-full overflow-hidden'>
          ...
          <div className='grid w-full max-w-sm items-center gap-1.5 mt-2'>
            <Label htmlFor='excel-file-center-private'>Upload Excel File (.xlsx, .csv)</Label>
            <Input
              id='excel-file-center-private'
              type='file'
              accept='.xlsx, .xls, .csv'
          ...
          {successMsg && (
            <Alert className='bg-[#2D3E2C]/10 text-[#2D3E2C] border-[#2D3E2C]/30 dark:bg-[#2D3E2C]/20 dark:text-[#a0b583] dark:border-[#a0b583]/30'>
              <FileSpreadsheet className='h-4 w-4 text-[#2D3E2C] dark:text-[#a0b583]' />
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!file || !selectedExamId || isUploading}
            className='bg-[#2D3E2C] hover:bg-[#202c1f] text-white border border-[#2D3E2C]'
          >
