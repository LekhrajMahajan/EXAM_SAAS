...
export const companySchema = z.object({
  ...
  gstNumber: z.string().max(20, "GST Number must be at most 20 characters").optional(),
  panNumber: z.string().max(20, "PAN Number must be at most 20 characters").optional(),
  registrationNumber: z.string().max(30, "Registration Number must be at most 30 characters").optional(),
