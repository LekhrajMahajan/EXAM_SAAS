    ...
    const plans = [
      {
        ...
        usageLimits: {
          maxBranches: 1, maxCenters: 5, maxEmployees: 10, maxCandidates: 1000, maxSubjects: 5, maxExams: 3, maxPapers: 10, maxQuestionBankSize: 1000,
      ...
      },
      {
        ...
        usageLimits: {
          maxBranches: 10, maxCenters: 50, maxEmployees: 100, maxCandidates: 50000, maxSubjects: 50, maxExams: 20, maxPapers: 100, maxQuestionBankSize: 50000,
      ...
      },
      {
        ...
        usageLimits: {
          maxBranches: 100, maxCenters: 500, maxEmployees: 1000, maxCandidates: 1000000, maxSubjects: 500, maxExams: 100, maxPapers: 1000, maxQuestionBankSize: 500000,
