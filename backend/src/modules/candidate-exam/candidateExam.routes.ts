...
router.post("/start-section", candidateExamStartSection);
...
router.post("/lock-section", candidateExamLockSection);
...
router.post("/set-part-order", candidateExamSetPartOrder);
