...
export const candidateExamStartSection = asyncHandler(
  async (req: Request, res: Response) => {
    const result = await candidateExamService.startSection(req.body);

    return sendResponse(res, HTTP_STATUS.OK, {
      success: true,
      message: "Candidate exam section started successfully.",
      data: result,
    });
  },
);
...
export const candidateExamLockSection = asyncHandler(
  async (req: Request, res: Response) => {
    const result = await candidateExamService.lockSection(req.body);

    return sendResponse(res, HTTP_STATUS.OK, {
      success: true,
      message: "Candidate exam section locked successfully.",
      data: result,
    });
  },
);
...
/*
|--------------------------------------------------------------------------
| Candidate Set Part Order
|--------------------------------------------------------------------------
*/

export const candidateExamSetPartOrder = asyncHandler(
  async (req: Request, res: Response) => {
    const result = await candidateExamService.setPartOrder(req.body);

    return sendResponse(res, HTTP_STATUS.OK, {
      success: true,
      message: "Part order saved successfully.",
      data: result,
    });
  },
);
