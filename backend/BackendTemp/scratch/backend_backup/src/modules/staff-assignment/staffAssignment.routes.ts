...
router.post(
  "/create",
  authorize(UserRole.MASTER_ADMIN, UserRole.COMPANY_ADMIN, UserRole.EXAM_MANAGER, UserRole.CENTER_MANAGER),
...
router.patch("/cancel", authorize(UserRole.MASTER_ADMIN, UserRole.COMPANY_ADMIN, UserRole.EXAM_MANAGER), cancelAssignment);
router.patch("/replace", authorize(UserRole.MASTER_ADMIN, UserRole.COMPANY_ADMIN, UserRole.EXAM_MANAGER), validate(replaceAssignmentSchema), replaceAssignment);
...
router.patch("/:id/cancel", authorize(UserRole.MASTER_ADMIN, UserRole.COMPANY_ADMIN, UserRole.EXAM_MANAGER), cancelAssignment);
router.patch("/:id/replace", authorize(UserRole.MASTER_ADMIN, UserRole.COMPANY_ADMIN, UserRole.EXAM_MANAGER), replaceAssignment);
