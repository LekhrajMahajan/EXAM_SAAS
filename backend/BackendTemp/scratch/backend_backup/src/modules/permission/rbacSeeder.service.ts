...
export const defaultSidebarItems = [
  ...
  { title: "Center Requests", route: "/company/centers/admin-requests", icon: "Inbox", permissionKey: "centers.view", featureKey: "", order: 5, isVisible: true },
  { title: "Exams", route: "/company/exams", icon: "CalendarCheck", permissionKey: "exams.view", featureKey: "", order: 6, isVisible: true },
  { title: "Question Bank", route: "/company/question-banks", icon: "Database", permissionKey: "question_bank.view", featureKey: "", order: 7, isVisible: true },
  { title: "Candidates", route: "/company/candidates", icon: "Users", permissionKey: "candidates.view", featureKey: "", order: 8, isVisible: true },
  { title: "Live Monitoring", route: "/company/live-monitoring", icon: "Activity", permissionKey: "live_monitoring.view", featureKey: "liveMonitoring", order: 9, isVisible: true },
  { title: "AI Proctoring", route: "/company/ai-proctoring", icon: "ShieldCheck", permissionKey: "ai_proctor.view", featureKey: "basicAiProctoring", order: 10, isVisible: true },
  { title: "Attendance & Biometrics", route: "/company/attendance", icon: "UserCheck", permissionKey: "attendance.view", featureKey: "", order: 11, isVisible: true },
  { title: "Results & Merit List", route: "/company/results", icon: "Award", permissionKey: "results.view", featureKey: "", order: 12, isVisible: true },
  { title: "Reports & Analytics", route: "/company/reports", icon: "BarChart", permissionKey: "reports.view", featureKey: "", order: 13, isVisible: true },
  { title: "Staff & Access", route: "/company/staff", icon: "UserCog", permissionKey: "staff.view", featureKey: "", order: 14, isVisible: true },
  { title: "Audit Logs", route: "/company/audit-logs", icon: "History", permissionKey: "audit_logs.view", featureKey: "", order: 15, isVisible: true },
  { title: "Settings", route: "/company/settings", icon: "Settings", permissionKey: "settings.view", featureKey: "", order: 16, isVisible: true },
];
