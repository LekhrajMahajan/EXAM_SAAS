...
export const getEmployeeAnalytics = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const filter = req.query as IAnalyticsFilter;
    if (user && user.companyId) {
      filter.companyId = user.companyId;
    }
    const analytics = await analyticsService.getEmployeeAnalytics(filter);
...
export const getChartAnalytics = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const analytics = await analyticsService.getChartAnalytics(filter);
...
export const getAssignmentAnalytics = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const analytics = await analyticsService.getAssignmentAnalytics(filter);
...
export const getFinanceAnalytics = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const analytics = await analyticsService.getFinanceAnalytics(filter);
...
export const getLiveAnalytics = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const analytics = await analyticsService.getLiveAnalytics(filter);
...
export const getTrustAnalytics = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const analytics = await analyticsService.getTrustAnalytics(filter);
