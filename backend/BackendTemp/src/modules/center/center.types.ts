...
export interface ICenterPaymentDetails {
  mode: "UPI" | "BANK";
  upiId?: string;
...
export interface ICenter {
  ...
  paymentDetails?: ICenterPaymentDetails;

  status: CenterStatus;
  accessibleByCompanies?: Types.ObjectId[];  // Companies approved to use this center via CompanyAdminRequest
  isDeleted: boolean;
  deletedAt?: Date | null;
